...
const (
	...
	RoomService_ListRooms_FullMethodName        = "/api.RoomService/ListRooms"
	RoomService_SearchRoomByName_FullMethodName = "/api.RoomService/SearchRoomByName"
...
type RoomServiceClient interface {
	...
	SearchRoomByName(ctx context.Context, in *SearchRoomByNameRequest, opts ...grpc.CallOption) (*SearchRoomByNameResponse, error)
...
func (c *roomServiceClient) SearchRoomByName(ctx context.Context, in *SearchRoomByNameRequest, opts ...grpc.CallOption) (*SearchRoomByNameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchRoomByNameResponse)
	err := c.cc.Invoke(ctx, RoomService_SearchRoomByName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RoomServiceServer interface {
	...
	SearchRoomByName(context.Context, *SearchRoomByNameRequest) (*SearchRoomByNameResponse, error)
...
func (UnimplementedRoomServiceServer) SearchRoomByName(context.Context, *SearchRoomByNameRequest) (*SearchRoomByNameResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchRoomByName not implemented")
}
...
func _RoomService_SearchRoomByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchRoomByNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoomServiceServer).SearchRoomByName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoomService_SearchRoomByName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoomServiceServer).SearchRoomByName(ctx, req.(*SearchRoomByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RoomService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SearchRoomByName",
			Handler:    _RoomService_SearchRoomByName_Handler,
		},
		{
